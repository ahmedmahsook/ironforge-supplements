    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          ...
          >
            <Heart size={16} />
            <span className="hidden sm:block font-medium">Wishlist</span>
            {wishlistCount > 0 && (
              <span className="absolute -top-1 -right-1 bg-pink-500 text-black
                text-[9px] w-4 h-4 flex items-center justify-center
          ...
          >
            ...
            {cartCount > 0 && (
              <span className="absolute -top-1 -right-1 bg-green-500 text-black
                text-[9px] w-4 h-4 flex items-center justify-center
                rounded-full font-bold leading-none">
                {cartCount}
              </span>
